...
public class SeckillTimeController {
	...
	@RequestMapping("/findTimeList")
	public  List<TbSeckillTime> findTimeList(){
		Date date = new Date();
		...
		String startDate=calendar.get(Calendar.YEAR)+"-"+monthstr+"-"+nowDatestr;
		...
		return seckillTimeService.findStartTimeByNoStart(startDate,nowTime);
	}
