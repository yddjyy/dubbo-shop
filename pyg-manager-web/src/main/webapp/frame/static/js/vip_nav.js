            ...
            $.get(addr, data, function (res) {
                ...
                if (res.data) {
                    $(res.data).each(function (k, v) {
                        ...
                        if (v.subset) {
                            view += '<a href="javascript:;" style="text-decoration:none;"><i class="layui-icon">' + v.icon + '</i>' + v.text + '</a><dl class="layui-nav-child">';
                            $(v.subset).each(function (ko, vo) {
                                view += '<dd>';
                                if(vo.target){
                                    view += '<a href="' + vo.href + '" target="_blank" style="text-decoration:none;">';
                                }else{
                                    view += '<a href="javascript:;" href-url="' + vo.href + '" style="text-decoration:none;">';
                                }
                            ...
                            if (v.target) {
                                view += '<a href="' + v.href + '" target="_blank" style="text-decoration:none;">';
                            } else {
                                view += '<a href="javascript:;" href-url="' + v.href + '" style="text-decoration:none;">';
                            }
