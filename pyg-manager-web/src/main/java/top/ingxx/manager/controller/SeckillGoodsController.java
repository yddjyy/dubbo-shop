...
import top.ingxx.entity.Result;
...
public class SeckillGoodsController {
	...
	@RequestMapping("/addSeckillGoodsList")
	public Result addSeckillGoodsList(List<TbSeckillGoods> seckillGoodsList){

		try {
			seckillGoodsService.addSeckillGoodsList(seckillGoodsList);
			return new Result(true, "添加秒杀成功");
		}catch (Exception e){
			e.printStackTrace();
			return new Result(false, "添加秒杀失败");
		}
