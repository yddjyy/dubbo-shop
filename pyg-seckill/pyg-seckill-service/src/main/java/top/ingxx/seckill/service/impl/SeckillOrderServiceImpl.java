...
import top.ingxx.mapper.TbSeckillOrderMapper;
import top.ingxx.pojo.TbSeckillGoods;
import top.ingxx.pojo.TbSeckillOrder;
import top.ingxx.pojo.TbSeckillOrderExample;
import top.ingxx.pojo.TbSeckillOrderExample.Criteria;
	...
	public void deleteOrderFromRedis(String userId, Long orderId) {
		...
		if(seckillOrder!=null){
			...
			if(seckillGoods!=null){ //如果不为空
				...
				//属性要设置。。。。省略
				seckillGoods =tbSeckillGoodsMapper.selectByPrimaryKey(seckillOrder.getSeckillId());
